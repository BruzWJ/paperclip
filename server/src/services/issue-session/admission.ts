...
function buildView(
  ...
  return {
    ...
    compositionCheckpointControlId: null,
    compositionTailStartMessageId: null,
    activeExecutionCheckpointControlId: null,
    activeExecutionTailStartMessageId: null,
    loweringGeneration: 0,
    sourceMessageId: ids.messageId,
    sourceInputId,
    invalidationReason: null,
    invalidatedAt: null,
