...
const ORGS: Record<string, OrgNode> = {
  sm: {
    ...
    status: "active",
    reports: [
      { id: "eng1", name: "Engineer", subtitle: "Engineering", status: "active", reports: [] },
      { id: "des1", name: "Designer", subtitle: "Design", status: "active", reports: [] },
    ],
  },
  med: {
    id: "lead",
    ...
    reports: [
      {
        ...
        status: "active",
        reports: [
          { id: "eng1", name: "ClaudeCoder", subtitle: "Engineering", status: "active", reports: [] },
          { id: "eng2", name: "CodexCoder", subtitle: "Engineering", status: "active", reports: [] },
          { id: "eng3", name: "SparkCoder", subtitle: "Engineering", status: "active", reports: [] },
          { id: "eng4", name: "CursorCoder", subtitle: "Engineering", status: "active", reports: [] },
          { id: "qa1", name: "QA", subtitle: "Quality", status: "active", reports: [] },
        ],
      },
      {
        id: "marketing",
    ...
    reports: [
      {
        ...
        status: "active",
        reports: [
          { id: "eng1", name: "Eng 1", subtitle: "Engineering", status: "active", reports: [] },
          { id: "eng2", name: "Eng 2", subtitle: "Engineering", status: "active", reports: [] },
          { id: "eng3", name: "Eng 3", subtitle: "Engineering", status: "active", reports: [] },
          { id: "qa1", name: "QA", subtitle: "Quality", status: "active", reports: [] },
        ],
      },
      {
        ...
        reports: [
          { id: "des1", name: "Designer", subtitle: "Design", status: "active", reports: [] },
          { id: "wrt1", name: "Content", subtitle: "Writing", status: "active", reports: [] },
        ],
      },
      {
        id: "finance",
        ...
        status: "active",
        reports: [
          { id: "fin1", name: "Analyst", subtitle: "Finance", status: "active", reports: [] },
        ],
      },
      {
        id: "operations",
        ...
        status: "active",
        reports: [
          { id: "ops1", name: "Ops 1", subtitle: "Operations", status: "active", reports: [] },
          { id: "ops2", name: "Ops 2", subtitle: "Operations", status: "active", reports: [] },
          { id: "devops1", name: "DevOps", subtitle: "Infrastructure", status: "active", reports: [] },
        ],
      },
    ],
  },
