...
const overview = await readFile(
  new URL("../apps/docs/adapters/overview.md", import.meta.url),
  "utf8",
);
const discoveryGuide = await readFile(
  new URL("../apps/docs/adapters/creating-an-adapter.md", import.meta.url),
  "utf8",
);
const externalAdapters = await readFile(
  new URL("../apps/docs/adapters/external-adapters.md", import.meta.url),
  "utf8",
);
