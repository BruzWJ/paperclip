...
const STORIES = [
  {
    id: "paperclip-source-task-recovery--recovery-action-card-states",
    label: "card-states",
  },
  {
    id: "paperclip-source-task-recovery--inbox-row-chips",
    label: "inbox-rows",
  },
  {
    id: "paperclip-source-task-recovery--blocker-notice-recovery-indicators",
    label: "blocker-notice",
  },
  {
    id: "paperclip-source-task-recovery--active-run-panel-recovery-chips",
