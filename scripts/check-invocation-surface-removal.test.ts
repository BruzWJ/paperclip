...
function fixtureRoot(): string {
  ...
  write(
    ...
    [
      ...
      "declare function createTaskExecutionTargetAcquirer(): unknown;",
      ...
      "const acquired = { targetCwd: '/workspace', release() {} };",
      ...
      "  probeAcpxRuntimeReadiness({ cwd: acquired.targetCwd, registryCwd: process.cwd() });",
      "  acquired.release();",
