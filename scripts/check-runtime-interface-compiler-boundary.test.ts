...
function fixtureRoot(): string {
  ...
  write(
    ...
    [
      ...
      "type RuntimeAgentConfigureTarget = {}; type RuntimeAgentCompanyToolOption = {};",
      "type SelectedCompanyTool = {}; type CompiledRunToolDescriptor = { name: string };",
      ...
      "  agentHireCompanyToolOptions: readonly RuntimeAgentCompanyToolOption[]; selectedCompanyTools: readonly SelectedCompanyTool[];",
      "}",
  ...
  write(
    ...
    [
      ...
      "function selectedCompanyTools() { return []; }",
      ...
      "    : [];",
      "  return { configureTargets, selectedCompanyTools: selectedCompanyTools() };",
      "}",
      "",
    ].join("\n"),
  );
  write(
    ...
    [
      ...
      "function grantSnapshot(value: unknown) { return value; }",
