...
function createRuntimeService(
  ...
  return {
    ...
    cwd: overrides.cwd ?? `${storybookRepoRoot}/apps/ui`,
...
export const storybookExecutionWorkspaces: ExecutionWorkspace[] = [
  ...
  },
  {
    ...
    config: {
      ...
      teardownCommand: "pnpm dev:stop && rm -rf apps/ui/storybook-static",
      cleanupCommand: null,
      workspaceRuntime: storybookWorkspaceRuntime,
      desiredState: "stopped",
...
export const storybookIssues: Issue[] = [
  ...
  createIssue({
    ...
    request: "Close the isolated release smoke workspace after static preview review.",
    boardPresentationStatus: "blocked",
    priority: "medium",
    ...
    projectId: "project-board-ui",
    projectWorkspaceId: "workspace-release-local",
    currentExecutionWorkspace: storybookExecutionWorkspaces[1]!,
    labelIds: ["label-ui", "label-risk"],
    labels: labelsFor(["label-ui", "label-risk"]),
...
export function createIssueExecutionRun(
  ...
  return {
    ...
    executionWorkspaceBindingId: "workspace-binding-storybook",
    executionMode: "owner",
