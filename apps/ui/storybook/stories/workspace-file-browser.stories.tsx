...
const recentList: WorkspaceFileListResponse = {
  ...
  items: [
    item("apps/ui/src/components/WorkspaceFileBrowser.tsx", 2),
    item("apps/ui/src/components/FileViewerSheet.tsx", 2),
    item("apps/server/src/routes/file-resources.ts", 14),
    item("doc/PRODUCT.md", 60),
    item("packages/shared/src/types/workspace-file-resource.ts", 64),
    item("apps/server/src/services/very/deeply/nested/structure/workspace-file-resources.ts", 180),
  ],
  scannedCount: 412,
  truncated: true,
};
...
const viewedResource: ResolvedWorkspaceResource = {
  ...
  displayPath: "apps/ui/src/components/FileViewerSheet.tsx",
  workspaceLabel: "issue execution workspace · PAP-1953",
  workspaceKind: "execution_workspace",
  workspaceId: "ws-1",
  contentType: "text/plain; charset=utf-8",
...
function ViewFromBrowseInner() {
  ...
  useEffect(() => {
    viewer.open(
      { path: "apps/ui/src/components/FileViewerSheet.tsx", line: 3, column: null, workspace: "auto" },
      { fromBrowse: true },
    );
...
function ViewFromBrowse() {
  ...
  queryClient.setQueryData(
    queryKeys.issues.fileResource(ISSUE_ID, {
      path: "apps/ui/src/components/FileViewerSheet.tsx",
      workspace: "auto",
    }),
    viewedResource,
  );
