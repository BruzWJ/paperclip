    ...
    return (
      <FileViewerShell
        ...
        seed={(client) =>
          seedContent(
            client,
            "apps/ui/src/components/FileViewerSheet.tsx",
            "execution",
            resource,
            content,
          )
...
export const BinaryUnsupported: Story = {
  ...
  render: () => {
    const resource = buildResource({
      title: "logo.woff2",
      displayPath: "apps/ui/public/fonts/logo.woff2",
    ...
    return (
      <FileViewerShell
        path="apps/ui/public/fonts/logo.woff2"
        workspace="auto"
        seed={(client) =>
          seedContent(
            client,
            "apps/ui/public/fonts/logo.woff2",
            "auto",
            resource,
            null,
          )
