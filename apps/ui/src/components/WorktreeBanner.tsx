    ...
    >
      <div className="flex items-center gap-2 overflow-hidden whitespace-nowrap">
        ...
        <button
          ...
          className="truncate border-none bg-transparent p-0 text-(length:--text-micro) font-semibold uppercase tracking-(--tracking-eyebrow) text-current transition-opacity hover:opacity-80"
        >
