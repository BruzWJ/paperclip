...
export const TreeProvider = ({
  ...
  const expandedIds = expansionIsControlled ? new Set(controlledExpandedIds) : internalExpandedIds;
  ...
  const toggleExpanded = useCallback(
    (nodeId: string) => {
      ...
      if (expansionIsControlled) {
        onExpandedIdsChange?.([...newSet]);
      } else {
        setInternalExpandedIds(newSet);
      }
    },
    [expandedIds, expansionIsControlled, onExpandedIdsChange],
  );
