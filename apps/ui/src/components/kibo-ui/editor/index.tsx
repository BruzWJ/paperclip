...
export type SlashSuggestions = NonNullable<SuggestionOptions<SuggestionItem>["items"]>;
export type SlashFindSuggestionMatch = NonNullable<SuggestionOptions<SuggestionItem>["findSuggestionMatch"]>;

export const defaultSlashSuggestions: SlashSuggestions = () => [
  {
    title: "Text",
...
export type EditorProviderProps = TiptapEditorProviderProps & {
  ...
  limit?: number;
  placeholder?: string;
  slashFindSuggestionMatch?: SlashFindSuggestionMatch;
    ...
    Slash.configure({
      suggestion: {
        items: async ({ editor, query, signal }) => {
          const items = await slashSuggestions({ editor, query, signal });
        ...
        char: "/",
        findSuggestionMatch: slashFindSuggestionMatch,
        render: () => {
