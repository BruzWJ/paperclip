...
export const Reel = ({
  ...
  return (
    ...
    >
      <div
        className={cn("relative isolate h-full w-auto overflow-hidden bg-black", "aspect-[9/16]", className)}
        {...props}
      />
    </ReelContext.Provider>
  );
...
export const ReelImage = ({
  ...
  }, [isPlaying, duration, currentIndex, setProgress, setCurrentIndex, data, progress, isTransitioning]);
