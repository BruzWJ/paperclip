...
/**
 * Helpers + selectors for the task Output surface (PAP-10162 Phase 3).
 *
 * The Output surface promotes attachment-backed artifact work products to a
 * first-class slot on the task page so cloud users can watch / download files
...
export function outputFilename(item: TaskOutputItem): string {
