...
import { ApprovalPayloadRenderer, approvalSubject, typeIcon, typeLabel } from "@/features/approvals/ApprovalPayload";
...
export interface TaskChatApprovalDecisionInput {
  approvalId: string;
