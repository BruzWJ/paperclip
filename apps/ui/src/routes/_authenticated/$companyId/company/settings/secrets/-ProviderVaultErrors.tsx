...
export function ProviderErrorDetails({ details }: { details: Record<string, unknown> }) {
  return (
    <div>
      <p className="text-sm font-medium">Safe request/error details</p>
      <JsonCodeBlock bodyClassName="max-h-36" filename="safe-error-details.json" value={details} />
    </div>
  );
}
