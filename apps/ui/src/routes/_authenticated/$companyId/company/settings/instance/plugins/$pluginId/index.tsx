 ...
 *
 * URL params:
 * - `companyId` — the canonical company UUID (for breadcrumb links).
                    ...
                    <div className="max-h-64 space-y-1 overflow-y-auto font-mono text-xs">
                      {recentLogs.map((entry) => (
                        ...
                        >
                          ...
                          <Badge
                            variant="outline"
                            className="h-4 shrink-0 px-1 text-(length:--text-nano)"
                          >
                            {entry.level}
                          </Badge>
              ...
              <Card>
                ...
                <CardContent className="space-y-3 text-sm text-muted-foreground">
                  ...
                  <div className="flex justify-between gap-3">
                    ...
                    <span
                      className="max-w-(--sz-170px) truncate text-right text-xs"
...
function PluginLocalFoldersSettings({
  pluginId,
  companyId,
  declarations,
    ...
    <div className="space-y-4 rounded-md border border-border/70 bg-background px-4 py-4">
      ...
      <div className="space-y-1.5">
        <label
          ...
          htmlFor={`local-folder-${declaration.folderKey}`}
        >
          Local folder path
        </label>
        <div className="flex items-center gap-2">
