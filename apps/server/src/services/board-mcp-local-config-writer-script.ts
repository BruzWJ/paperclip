/**
 * Standalone node script that writes the Paperclip MCP server entry into a
 ...
 * registry, with Paperclip using a standard `Authorization: Bearer` header
