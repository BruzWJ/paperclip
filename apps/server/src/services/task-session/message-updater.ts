...
export interface TaskSessionMessageStore {
  ...
  appendMessage(message: TaskSessionMessage): Promise<void>;
}

function cloneMessage<T extends TaskSessionMessage>(message: T): T {
  return decodeTaskSessionMessage(encodeTaskSessionMessage(message)) as T;
}

async function updateAssistant(
  store: TaskSessionMessageStore,
