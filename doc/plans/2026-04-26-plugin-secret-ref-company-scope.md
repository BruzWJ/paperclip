...
- [packages/db/schema/plugin_config.ts](/Users/dotta/paperclip/.paperclip/worktrees/PAP-2339-secrets-make-a-plan/packages/db/schema/plugin_config.ts:15) stored one config row per plugin, with no company dimension.
- [packages/db/schema/company_secret_bindings.ts](/Users/dotta/paperclip/.paperclip/worktrees/PAP-2339-secrets-make-a-plan/packages/db/schema/company_secret_bindings.ts:5) already modeled bindings as company-scoped.
