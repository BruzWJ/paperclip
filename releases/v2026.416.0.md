...
- **Task detail stability** — Fixed visible refreshes during agent updates, comment post resets, ref update loops, split regressions, main-pane focus on navigation, and other detail-view rerender defects. ([#3355](https://github.com/paperclipai/paperclip/pull/3355))
