...
- **PostgreSQL deployment** — Historical local-cluster startup handling was retired in favor of an external database target. (@vkartaviy)
...
- **Dev runner syntax** — Fixed a syntax defect in the plugin dev runner. ([#914](https://github.com/paperclipai/paperclip/pull/914), @gsxdsm)
