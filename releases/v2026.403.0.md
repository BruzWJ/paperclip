...
- **Session continuity (historical; retired)** — Timer and heartbeat wakes preserved the former agent/task-key session. That correlation was explicitly dropped at the task-execution cutover; current continuity is task-execution-scoped and this behavior cannot be re-enabled.
