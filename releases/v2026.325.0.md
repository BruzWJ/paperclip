...
- **PostgreSQL deployment in Docker slim** — Historical local-cluster startup handling was retired in favor of an external database service. ([#737](https://github.com/paperclipai/paperclip/pull/737), @alaa-alghazouli)
...
- **Same-page task toasts** — Suppressed redundant toasts when navigating to a task already on screen.
