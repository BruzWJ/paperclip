...
This is an idea file, designed to be copied into your coding agent. Its goal is to communicate the high-level idea while your agent builds the specifics with you.
