      ...
      <div className="mt-4 rounded-md border border-border bg-popover p-1 text-xs">
        ...
        <div className="flex w-full items-start gap-2 rounded px-2 py-1.5 hover:bg-accent/50">
          ...
          <span className="flex flex-col text-left leading-tight">
            <span>Backlog</span>
            <span className="text-[10px] text-muted-foreground">Parked — owner will not be dispatched</span>
          </span>
        </div>
        <div className="flex w-full items-start gap-2 rounded bg-accent px-2 py-1.5">
          ...
          <span className="flex flex-col text-left leading-tight">
            <span>Todo</span>
            <span className="text-[10px] text-muted-foreground">Executable — owner will be woken</span>
          </span>
        </div>
      </div>
    </div>
...
const meta = {
  title: "Paperclip/Owner Backlog Safeguards",
  component: AllStates,
