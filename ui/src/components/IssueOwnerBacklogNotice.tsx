...
interface IssueOwnerBacklogNoticeProps {
  issueStatus: string;
...
export function IssueOwnerBacklogNotice({
  issueStatus,
  ownerAgent,
  ownerUserId,
  onResume,
  resuming,
}: IssueOwnerBacklogNoticeProps) {
  ...
  return (
    <div
      data-testid="issue-owner-backlog-notice"
          ...
          {onResume ? (
            <div className="pt-0.5">
              <Button
                ...
                onClick={onResume}
                disabled={resuming}
                data-testid="issue-owner-backlog-resume"
              >
